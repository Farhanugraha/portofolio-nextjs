  ...
  return (
    <div className="flex justify-center items-center gap-2 mt-8">
      <Link
        ...
        className={`w-8 h-8 flex items-center justify-center px-0 py-0 rounded bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 transition-transform duration-150 ${
          currentPage === 1
      ...
      <Link
        ...
        className={`w-8 h-8 flex items-center justify-center rounded transition-colors duration-150 ${
          currentPage === 1
            ...
            : "bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700"
        }`}
